...
Peripheral.prototype.connect = function (callback) {
    ...
    if (!_.isNil(this.connHdl)) {
        ...
        periphOnlineHdlr = function (msg) {
            if (msg.type === 'DEV_ONLINE' && msg.data === self.addr) {
...
Peripheral.prototype.remove = function (callback) {
    ...
    if (_.isNil(this.connHdl)) {
        this._controller.getShepherd()._periphBox.remove(this.id, function () {});
        deferred.resolve();
    } else { 
        this._controller.disconnect(this).then(function () {
            self._controller.getShepherd()._periphBox.remove(self.id, function () {});
            deferred.resolve();
        }).fail(function (err) {
            deferred.reject(err);
        }).done();
...
Peripheral.prototype.updateLinkParam = function (interval, latency, timeout, callback) {
    ...
    updateLinkParamFunc = function (deferred) {
        self._controller.updateLinkParam(self, setting).done(function () {
...
Peripheral.prototype.encrypt = function (setting, callback) {
    ...
    encryptFunc = function (deferred) {
        self._secMdl.init().then(function () {
...
Peripheral.prototype.passPasskey = function (passkey, callback) {
    ...
    passPasskeyFunc = function (deferred) {
        self._secMdl.passPasskey(passkey).done(function () {
            deferred.resolve();
        }, function (err) {
            deferred.reject(err);
        });
...
Peripheral.prototype.readDesc = function (uuidServ, uuidChar, callback) {
    ...
    readDescFunc = function (deferred) {
