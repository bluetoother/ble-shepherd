...
Characteristic.prototype.readDesc = function (callback) {
    ...
    return this._controller.readDesc(this).then(function (result) {
        self.desc = result;
...
Characteristic.prototype.write = function (value, withoutResponse, callback) {
    var self = this,
        deferred = Q.defer(),
        oldVal = this.value,
        charInfo = {
    ...
    if (!_.includes(this.prop, 'write') && !_.includes(this.prop, 'writeWithoutResponse')) 
        ...
        this._controller.write(this, value, withoutResponse).done(function () {
            self.value = value;
...
Characteristic.prototype.dump = function () {
    return {
        uuid: this.uuid,
        handle: this.handle,
        prop: _.cloneDeep(this.prop),
        desc: this.desc || null,
        value: _.cloneDeep(this.value) || null
    };
};
