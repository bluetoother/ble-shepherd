...
Central.prototype.regServ = function (servInfo) {
    ...
    return ccbnp.gatt.addService('0x2800', (_.size(attrs) + 1)).then(function (result) {
...
Central.prototype.delServ = function (handle, callback) {
    ...
    proving.number(handle, 'handle must be a number');
...
Service.prototype._addChars = function (charsInfo) {
    ...
    proving.array(charsInfo, 'Argument charsInfo must be an array.');
...
Characteristic.prototype._addAttrs = function (charInfo) {
    ...
    proving.object(charInfo, 'charInfo must be an object.');
