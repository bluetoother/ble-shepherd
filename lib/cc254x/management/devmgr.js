...
Devmgr.prototype.pauseDev = function () {
...
BleDevice.prototype.getServs = function () {
    var self = this,
        deferred = Q.defer(),
        servObj,
        service,
...
BleDevice.prototype.loadServs = function () {
    var self = this,
        deferred = Q.defer(),
        serv,
        loadCharFuncs = [];
...
BleDevice.prototype.removeFromDb = function () {
    var self = this,
        deferred = Q.defer(),
...
BleDevice.prototype.read = function (uuidServ, uuidChar, callback) { 
    var deferred = Q.defer(),
        char,
        checkErr;
...
BleDevice.prototype.write = function (uuidServ, uuidChar, value, callback) { 
    var deferred = Q.defer(),
        char,
        checkErr;
...
BleDevice.prototype.readDesc = function (uuidServ, uuidChar, callback) { 
    var deferred = Q.defer(),
        char,
        checkErr;
...
BleDevice.prototype.setNotify = function (uuidServ, uuidChar, config, callback) { 
    var deferred = Q.defer(),
        char,
        checkErr;
...
BleCentral.prototype._processAttMsg = function (attMsg) {
    var deferred = Q.defer(),
        servs = [],
        attrs = [],
        attr,
