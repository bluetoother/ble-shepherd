...
Devmgr.prototype.pauseDev = function (callback) {
    var deferred = Q.defer(),
        onlineNum = 0,
        onlineDev;

    _.forEach(this.bleDevices, function (dev) {
        if (dev.state === 'online') {
            onlineNum += 1;
        }
    });
    ...
    if (onlineNum === 3) {
        onlineDev = _.find(this.bleDevices, {state: 'online'});

        if (onlineDev) {
            onlineDev.disconnect().then(function () {
                onlineDev.state = 'pause';
                deferred.resolve(onlineDev.addr);
            }).fail(function (err) {
                deferred.reject(err);
            }).done();
        } else {
...
BleDevice.prototype.connect = function (callback) {
    ...
    timeout = setTimeout(function () {
        self.cancelConnect().fail(function () {}).done();
    }, 3000);
...
BleDevice.prototype.updateLinkParam = function (interval, latency, timeout, callback) { //V
    var deferred = Q.defer();
...
BleDevice.prototype.encrypt = function (setting, callback) { //V
    var self = this,
        deferred = Q.defer(),
        checkErr;
...
BleDevice.prototype.update = function (callback) { //V
    var self = this,
        deferred = Q.defer(),
    ...
    _.forEach(this.servs, function (serv, servName) {
        if (!_.includes(notUpdate, notUpdate)) {
...
BleDevice.prototype.remove = function (callback) { //V
    var self = this,
        deferred = Q.defer();
...
/****Characteristic****/
BleDevice.prototype.findChar = function (uuidServ, uuidChar) {
    var serv,
        servObj,
        charObj;
...
BleDevice.prototype.read = function (uuidServ, uuidChar, callback) { //V
    var deferred = Q.defer(),
        char,
        checkErr;
...
BleDevice.prototype.write = function (uuidServ, uuidChar, value, callback) { //V
    var deferred = Q.defer(),
        char,
        checkErr;
...
BleDevice.prototype.readDesc = function (uuidServ, uuidChar, callback) { //V
    var deferred = Q.defer(),
        char,
        checkErr;
...
BleDevice.prototype.setNotify = function (uuidServ, uuidChar, config, callback) { //V
    var deferred = Q.defer(),
        char,
        checkErr;
...
BleDevice.prototype.regCharHdlr = function (uuidServ, uuidChar, fn) {
