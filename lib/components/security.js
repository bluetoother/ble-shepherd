...
function Secmdl(setting) {
    ...
    this.pairMode = setting.pairMode ? setting.pairMode : GAPDEFS.PairingMode.get('WaitForReq').value;
    this.ioCap = setting.ioCap ? setting.ioCap : GAPDEFS.IoCap.get('KeyboardDisplay').value; 
    this.mitm = setting.mitm ? setting.mitm : true;
    this.bond = setting.bond ? setting.bond : true;
    this.ltk = null;
    this.div = null;
    this.rand = null;
}
