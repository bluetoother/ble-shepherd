...
Controller.prototype.write = function (char, value, withoutResponse) {
    return this.drivers.write(char, value, withoutResponse);
};
...
Controller.prototype.secure = function (periph) {
    return this.drivers.secure(periph);
};
