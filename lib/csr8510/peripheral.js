...
Characteristic.prototype.buildChar = function (data) {
    return charBuild(this.uuid).transToValObj(data).getHciCharBuf();
};
...
Characteristic.prototype.discrimChar = function (data) {
    ...
    return charDiscrim(uuid).getCharValPacket(data);
};
