...
BShepherd.prototype._examinePeriph = function (periph) {
    ...
    _.forEach(plugins, function (plgInfo, periphName) {
        ...
        if (periph.findChar('0x180a', '0x2a24'))
            basicInfo.manufacturer = periph.findChar('0x180a', '0x2a24').value.modelNum;
        if (periph.findChar('0x180a', '0x2a25'))
            basicInfo.manufacturer = periph.findChar('0x180a', '0x2a25').value.serialNum;
        if (periph.findChar('0x180a', '0x2a26'))
            basicInfo.manufacturer = periph.findChar('0x180a', '0x2a26').value.firmwareRev;
        if (periph.findChar('0x180a', '0x2a27'))
            basicInfo.manufacturer = periph.findChar('0x180a', '0x2a27').value.hardwareRev;
        if (periph.findChar('0x180a', '0x2a28'))
            basicInfo.manufacturer = periph.findChar('0x180a', '0x2a28').value.softwareRev;
